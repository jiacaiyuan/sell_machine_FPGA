...
#
# Generated: 2018-04-03 14:57:10.219
...
ptf=C:\Users\Dell\Desktop\avalon_sis\KERNEL.ptf
...
if test -f /cygdrive/f/quartus/nios2eds/components/altera_hal/build/os.sh ; then
   . /cygdrive/f/quartus/nios2eds/components/altera_hal/build/os.sh
fi
